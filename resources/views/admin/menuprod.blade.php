        ...
        <div class="subcategories">
            ...
            <div data-nom="{{ $product->Nom }}" data-id="{{ $product->id }}" data-prix="{{ $product->Prix }}">
                ...
                <button type="button" class=" add-to-cart subcategory-square">
                    <!-- Image du produit -->
                    <div>
                        <img src="{{ $product->photo }}" width="50px" class="img img-responsive">
                    </div>
                ...
                <form action="{{ route('produit.dupliquer', $product->id) }}" method="POST" style="display:inline">
                    @csrf
                    <button type="submit"
                        style="font-size:11px; padding:3px 8px; margin-top:4px; background:#6c757d; color:white; border:none; border-radius:4px; cursor:pointer;"
                        onclick="return confirm('Dupliquer {{ $product->Nom }} ?')">
                        ⧉ Dupliquer
                    </button>
                </form>
            </div>
                ...
                <div class="modal-header">
                    <form id="command-form" action="{{ route('save.command') }}" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="commandModal">Payer</button>
                        </div>
                    </form>
                </div>
            </div>
